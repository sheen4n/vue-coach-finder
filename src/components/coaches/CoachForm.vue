<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control" :class="{ invalid: !rate.isValid }">
      ...
      />
      <p v-if="!rate.isValid">Rate must be a positive number.</p>
    </div>
    ...
    <div class="form-control" :class="{ invalid: !areas.isValid }">
      ...
      <p v-if="!areas.isValid">Select at least one specialization.</p>
    </div>

    <p v-if="!formIsValid">Please fix the above the errors</p>
